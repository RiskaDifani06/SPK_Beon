...
@section('main')
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Edit Data Calon Karyawan</h4>
                @if ($errors->any())
                ...
                @endif
                @foreach ($uc as $item)
                    <form class="forms-sample" method="POST" action="/editdaka" enctype="multipart/form-data">
                        @csrf
                        ...
                        <a href="/datakaryawan" class="btn btn-light">Kembali</a>
                    </form>
                @endforeach
            </div>
        </div>
